...
class UtilisateurManager {
    ...
    public function add($last_name,$first_name,$username,$email,$password){
        $sql='INSERT INTO users(last_name,first_name,username,email,password) VALUES (:last_name,:first_name,:username,:email,:password)';
